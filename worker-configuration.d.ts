/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: ea18196522f1ee0c906d33d54afee3cf)
// Runtime types generated with workerd@1.20260915.1 2026-09-17 
interface __BaseEnv_Env {
	CALENDAR_KV: KVNamespace;
	CALENDAR_TOKEN: string;
	TAURON_CITY: string;
	TAURON_STREET: string;
	TAURON_HOUSE_NUMBER: string;
	TAURON_MESSAGE_PREFIX: string;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "CALENDAR_TOKEN" | "TAURON_CITY" | "TAURON_STREET" | "TAURON_HOUSE_NUMBER" | "TAURON_MESSAGE_PREFIX">> {}
}
